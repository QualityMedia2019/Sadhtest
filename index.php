...
<head>
    ...
    <![endif]-->       
    <link rel="shortcut icon" href="images/sdlogo.jpg">
...
<div id="wrapper" style="background:url('images/construct-bg.jpg');">

<div class="container"  style="background-color: white; box-shadow: 0px 5px 5px rgba(0, 0, 0, 0.39);">
<div >
    <header id="header">
        <nav id="main-menu" class="container navbar navbar-default navbar-fixed-top" role="banner">
            <div class="container">
               <div class="col-lg-5">
				
                <div class="collapse navbar-collapse navbar-left" style="
...
">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="scroll"><a href="#portfolio">Careers</a></li>
                        <li class="scroll"><a href="#about">Feedback</a></li>
...
">
                  ...
                  <a class="navbar-brand" href="index.html"><div class="col-lg-2"><img src="images/logo.png" alt="logo" style="
    /* float: right; */
...
"><span style="
    ...
    ">Sadhguru Souharda Sahakari Ltd</span></div></a>
                </div></div>
            </div><!--/.container-->
        </nav><!--/nav-->
    </header><!--/header-->
    ...
    <section id="main-slider">
        <div class="owl-carousels">
            <div class="item" style="background-image: url(images/slider/sadhgurubanner2.jpg);">
                <div class="slider-inner">
                    <div class="container">
                        <div class="row">
						  ...
						  <center>
						    <div class="col-lg-6">
                                    <h2><span>SADHGURU </span> Souharda Sahakari Ltd.</h2>
                                    <p>Founded by group of like-minded people with sole objective of building a strong future for next generation</p>
                                    <a class="btn btn-default btn-lg" href="#">Read More</a>
									     </div></center>
                                </div>
										  <div class="col-lg-5">
                              <div class="grid_4" style="    margin-right: 4%;	margin-top:45%;
    width: 370px;
    float: right;
    min-height: 1px;
    margin-left: 30px;"> <a href="#" class="banner " style="
    /* background-color: #000000 !important; */
    background-color:#017fafb8;
    color: #ffffff;
    display: block;
    width:  43%;
    text-align: center;
...
">
          <div class="maxheight" style="height: 87px;"><div class="box_inner">
            <div class="fa fa-inr" aria-hidden="true"style="
    margin-bottom: 7px;
    display: block;
    font-size: 55px;
    line-height: 48px;
"></div>
          Financial Service Division</div></div>
          </a> <a href="#" class="banner " style="
...
">
          <div class="maxheight" style="height:87px;"><div class="box_inner">
            <div class="fa fa-shopping-cart" aria-hidden="true" style="
   margin-bottom: 7px;
    display: block;
    font-size:55px;
    line-height: 48px;
"></div>
           Sales Division - A Kendra</div></div>
          </a> <a href="#" class="banner " style="
    background-color:#017faf;
    padding-top: 63px;
    padding-bottom: 13px;
    ...
    padding-bottom: 5%;
">
          <div class="maxheight1" style="height: 87px;"><div class="box_inner">
            <div class="fa fa-spinner" aria-hidden="true" style="
 margin-bottom: 7px;
    display: block;
    font-size: 55px;
    line-height: 48px;
"></div>
            Service Division</div></div>
          </a> <a href="#" class="banner " style="
    ...
    padding-bottom: 5%;">
          <div class="maxheight1" style="height:87px;"><div class="box_inner">
            <div class="fa fa-medkit" aria-hidden="true" style="
margin-bottom: 7px;
    display: block;
    font-size: 30px;
    line-height: 15px;
"></div>
           Pradhana Mantri Bharathiya Jana Aaushadiya Kendra - Udupi</div></div>
          </a> </div></div>
                        </div>
                    </div>
                </div>
...
<div class="scrollblock">
  <section id="feature">
    <div class="container">
      <div class="col-lg-12 row" style="background:#017faf;height:38px;color:white; padding-left: 0px;  font-size:17px; ">
<!-- <div class="col-lg-2" style=" padding-left: 0px;">
       <img src="images/latest.png" alt="logo" style=" float: left;"></div> -->
			  <div class="col-lg-10" style="padding-top: 5px;">
	<MARQUEE DIRECTION=LEFT>Sadhguru Souharda Sahakari Ltd.</MARQUEE></div>
        ...
        <div class="container">
                ...
                <div class="col-sm-6">
                    <div class="media service-box wow fadeInRight">
                        ...
                        <div class="media-body">
                            <h4 class="media-heading"> Financial Service Division</h4>
           ...
           Sales Division - A Kendra</h4>
                    ...
                    <i class="fa fa-spinner" aria-hidden="true"></i>
                        ...
                        <div class="media-body">
                            <h4 class="media-heading">   Service Division</h4>
                            <p>Backed by some of the biggest names in the industry, Firefox OS is an open platform that fosters greater</p>
                        </div>
                    </div>
                    ...
                    <div class="media service-box wow fadeInRight">
                        ...
                        <div class="media-body">
                            <h4 class="media-heading">  Pradhana Mantri Bharathiya Jana Aaushadiya Kendra - Udupi.</h4>
                            <p>Backed by some of the biggest names in the industry, Firefox OS is an open platform that fosters greater</p>
                        </div>
                    </div>
                </div>
    ...
    <section id="cta2">
        <div class="container">
            <div class="text-center">
                <h2 class="wow fadeInUp" data-wow-duration="300ms" data-wow-delay="0ms"><span>Sadhguru Sahakari </span></h2>
                <p class="wow fadeInUp" data-wow-duration="300ms" data-wow-delay="100ms">  It is a non-profiting organization registered under the Indian Trust Act. It is founded by a group of like-minded people with the sole objective of building a strong future for the next generation through a value based and knowledge based educational system. It holds the belief that this is the most effective way of preserving the Indian values, that will go a long way in building a strong India. We are inviting you to participate in our project and support us. We are looking your full-hearted support and guidance. Encourage and support our endeavours.</p>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-sm-6 wow fadeInRight">
                    <h3 class="column-title">SADHGURU Capability</h3>
    ...
    <footer id="footer">
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    &copy; 2017 Your Company. Designed by <a target="_blank" href="#" >Mahathi Solutions</a>
                </div>
                <div class="col-sm-6">
                    <ul class="social-icons">
                        <li><a href="#"><i class="fa fa-facebook"></i></a></li>
